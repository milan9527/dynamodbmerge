...
public class GameMailboxMergedItem extends GameMailboxItem implements Serializable {
    ...
    public GameMailboxMergedItem(String mailId, String userId, String gameId, boolean isDelete) {
        this.setMailId(mailId);
        this.setUserId(userId);
        this.gameId = gameId;
        this.deleteOperation = isDelete;
        
        // Generate partition keys
        this.PK = gameId + "#" + mailId;
